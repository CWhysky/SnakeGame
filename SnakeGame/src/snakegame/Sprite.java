...
/**
 *
 * Sprite.java is a utility class to help manage the creation of elements in the
 * Snake game. Apple.java, Snake.java, and Wall.java should all extend this
 * class and leverage the functions in it. You may modify this class but please
 * do not make any object-specific modifications; whatever you change in this
 * class needs to work for all objects that use this class.
 *
 * @author ascott
 *
 */
public class Sprite {
    ...
    /**
     * getPosX - Returns the position of the Sprite on the X axis.
     *
    ...
    /**
     * getPosY - Returns the position of the Sprite on the Y axis.
     *
    ...
    /**
     * setImage - sets the image i and sets the height and width of the sprite
     * based on the height and width of the image.
     *
     * @param i the image
     */
    ...
    /**
     * getImage - Gets the image stored in the Sprite.
     *
    ...
    /**
     * getAngle - Gets the angle the Sprite is currently traveling in.
     *
    ...
    /**
     * setImage - Creates a new Image based on a file path then calls setImage.
     *
    ...
    /**
     * setPosition - Sets the position of x and y on the gameGrid.
     *
    ...
    /**
     * setVelcity - Sets the velocity in the x and y direction on the gameGrid.
     *
    ...
    /**
     * addVelocity - Sums velocity to the current velocity.
     *
    ...
    /**
     * update - Changes the position of the sprite based on the velocity and
     * time.
     *
     *
    ...
    /**
     * render - Draws the image on the game map.
     *
    ...
    /**
     * getBoundary - Returns the edge of the Sprite.
     *
    ...
    /**
     * intersects - Checks to see if the this Sprite has hit another Sprite.
     *
    ...
    /**
     * toString() - Debug method. Dumps the attribute states to screen.
     *
     * @return returns a string representation of the current position and
     * velocity
     */
    ...
    /**
     * setPosition - sets the position of this sprite behind the last snake body
     * part in the snake.
     *
    ...
    /**
     * setVelocity - Sets the velocity and angle of the sprite based on the
     * velocity and angle of the last body piece in the snake.
     *
    ...
    /**
     * getVelocityX - Gets the velocity of the sprite in the X direction.
     *
    ...
    /**
     * getVelocityY - Gets the velocity of the sprite in the Y direction.
     *
